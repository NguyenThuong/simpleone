<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=product&amp;action=edit" enctype="multipart/form-data" role="form">
            ...
            <div class="form-group">
                <label for="summary" class="col-sm-3 control-label">Thông tin</label>
                <div class="col-sm-9">
                    <textarea name="summary" rows=5 class="form-control" id="summary" placeholder="Thông tin sản phẩm" /><?php echo $product ? $product['summary'] : ''; ?></textarea>
                </div>
            </div>                               
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <?php if ($product && is_file('public/upload/product/'.$product['image'])) {
                        echo '<image src="public/upload/product/'.$product['image'].'?time='.time().'" style="max-width:200px;" />';
                        }
                    ?>
                </div>
            </div>
